...
class NavTest():
    def __init__(self):
        ...
        locations['hall_foyer'] = Pose(Point(40.456, 48.037, 0.000), Quaternion(0.000, 0.000,- 0.392, 0.920))
        locations['hall_kitchen'] = Pose(Point(50.707, 48.731, 0.000), Quaternion(0.000, 0.000, -0.933, 0.361))
        locations['hall_bedroom'] = Pose(Point(45.345, 43.399, 0.000), Quaternion(0.000, 0.000, 0.921, -0.390))
